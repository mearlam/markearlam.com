...
function Privacy(props) {
    ...
    useEffect(() => {
        document.title = `Mark Earlam - Privacy`;
    });
    ...
    return (
        <TextContainer>
            <header>
                ...
                This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from www.markearlam.com (the “Site”).<br/>
                ...
                {/*[[INSERT ANY OTHER INFORMATION YOU COLLECT:  OFFLINE DATA, PURCHASED MARKETING DATA/LISTS]]<br/>*/}
                ...
                <h4>CONTACT US</h4>
                For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at mark.earlam@gmail.com or by mail using the details provided below:<br/>
        </TextContainer>
    );
}
